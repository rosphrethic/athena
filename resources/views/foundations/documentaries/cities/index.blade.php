        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title mt-0" id="modal-title">Gestión de Ciudades</h5>
                        ...
                        <div class="card-body">
                            <form id="form" style="margin-bottom: -40px !important;" autocomplete="off">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <input id="acronym" name="acronym" type="search" class="form-control" required style="text-transform: uppercase;">
                                    </div>
                                </div>
...
<script>
    function loadTable() {
        $('#table').DataTable({
            ...
            ajax: {
                type: "GET",
                url: '/foundations/documentaries/cities/getAll',
                dataSrc: ""
            },
            dom: 'l<"toolbar">frtip',
    ...
    function show(id) {
        ...
        $.ajax({
            type: "GET",
            url: '/foundations/documentaries/cities/getOne',
            data: {
                id: id
            },
        }).done(function(data) {
    ...
    function store() {
        $.ajax({
            type: "GET",
            url: '/foundations/documentaries/cities/store',
            data: $('#form').serialize()
    ...
    function update() {
        $.ajax({
            type: "GET",
            url: '/foundations/documentaries/cities/update',
            data: $('#form').serialize()
    ...
    function destroy() {
        $.ajax({
            type: "GET",
            url: '/foundations/documentaries/cities/destroy',
            data: {
                id: $('#id').val(),
            }
        }).done(function() {
