        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title mt-0" id="modal-title">Gestión de Secciones</h5>
...
<script>
    function loadTable() {
        $('#table').DataTable({
            ...
            ajax: {
                type: "GET",
                url: '/foundations/academics/sections/getAll',
                dataSrc: ""
            },
            dom: 'l<"toolbar">frtip',
    ...
    function show(id) {
        ...
        $.ajax({
            type: "GET",
            url: '/foundations/academics/sections/getOne',
            data: {
                id: id
            },
        }).done(function(data) {
    ...
    function store() {
        $.ajax({
            type: "GET",
            url: '/foundations/academics/sections/store',
            data: $('#form').serialize()
        }).done(function() {
            success();
        }).fail(function(jqXhr) {
    ...
    function update() {
        $.ajax({
            type: "GET",
            url: '/foundations/academics/sections/update',
            data: $('#form').serialize()
    ...
    function destroy() {
        $.ajax({
            type: "GET",
            url: '/foundations/academics/sections/destroy',
            data: {
                id: $('#id').val(),
            }
        }).done(function() {
