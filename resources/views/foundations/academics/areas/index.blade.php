        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title mt-0" id="modal-title">Gestión de Áreas</h5>
...
<script>
    function loadTable() {
        $('#table').DataTable({
            ...
            ajax: {
                type: "GET",
                url: '/foundations/academics/areas/getAll',
                dataSrc: ""
            },
            dom: 'l<"toolbar">frtip',
    ...
    function show(id) {
        ...
        $.ajax({
            type: "GET",
            url: '/foundations/academics/areas/getOne',
            data: {
                id: id
            },
        }).done(function(data) {
    ...
    function store() {
        $.ajax({
            type: "GET",
            url: '/foundations/academics/areas/store',
            data: $('#form').serialize()
    ...
    function update() {
        $.ajax({
            type: "GET",
            url: '/foundations/academics/areas/update',
            data: $('#form').serialize()
    ...
    function destroy() {
        $.ajax({
            type: "GET",
            url: '/foundations/academics/areas/destroy',
            data: {
                id: $('#id').val(),
            }
        }).done(function() {
